...
public enum SCHEMATIC_TAG {
    SERPULO, EREKIR,
    // Resource
    COPPER, LEAD, COAL, SCRAP, GRAPHITE, METAGLASS, SILICON, SPORE_POD, TITANIUM, PLASTANIUM, PYRATITE, BLAST_COMPOUND, THORIUM, PHASE_FABRIC, SURGE_ALLOY, BERYLIUM, TUNGSTEN, OXIDE, CARDIBE,
    // Liquid
    ...
    // POWER
    COMBUSTION, THERMAL, STEAM, DIFFERENTIAL, RTG, SOLAR, THORIUM_REACTOR, IMPACT_REACTOR, TURBINE_CONDENSER, CHEMICAL_COMBUSTION, PYROLYSIS, FLUX_REACTOR, NEOPLASIA_REACTOR,
    // Utils
